...
struct sysent sysent[] = {
	...
	{ 0, (sy_call_t *)sys_inotify_init },		/* 532 = inotify_init */
	{ AS(inotify_init1_args), (sy_call_t *)sys_inotify_init1 },	/* 533 = inotify_init1 */
	{ AS(inotify_add_watch_args), (sy_call_t *)sys_inotify_add_watch },	/* 534 = inotify_add_watch */
	{ AS(inotify_rm_watch_args), (sy_call_t *)sys_inotify_rm_watch },	/* 535 = inotify_rm_watch */
};
