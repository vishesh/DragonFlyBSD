...
struct	dfbsd12_getdirentries_args {
#ifdef _KERNEL
	struct sysmsg sysmsg;
#endif
	int	fd;	char fd_[PAD_(int)];
...
int	sys_dfbsd12_stat (struct dfbsd12_stat_args *);
int	sys_dfbsd12_fstat (struct dfbsd12_fstat_args *);
int	sys_dfbsd12_lstat (struct dfbsd12_lstat_args *);
int	sys_dfbsd12_getdirentries (struct dfbsd12_getdirentries_args *);
int	sys_dfbsd12_getdents (struct dfbsd12_getdents_args *);
int	sys_dfbsd12_fhstat (struct dfbsd12_fhstat_args *);
